...
function ListAssignmentVideo() {
    ...
    const fetchAssignmentAndSubmissions = async () => {
        ...
        try {
            ...
            const assignmentResponse = await axios.get(`http://studentkonnekt-backend-api.onrender.com/assignments/${assignmentId}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            setAssignment(assignmentResponse.data);

            // Fetch submissions for the specific assignment
            const submissionsResponse = await axios.get(`http://studentkonnekt-backend-api.onrender.com/assignments/${assignmentId}/submissions`, {
                headers: { Authorization: `Bearer ${token}` }
            });
