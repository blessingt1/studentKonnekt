    ...
    <>
      ...
      <div className="container-fluid bg-dark">
        <div className="row py-2 px-lg-5">
          <div className="col-lg-6 text-left mb-2">
            <div className="d-inline-flex align-items-left text-white">
              <small>(+27 18) 299 1111</small>
              <small className="mx-2">|</small>
              <small>studies@nwu.ac.za</small>
            </div>
          </div>
      ...
      <div className="container-fluid p-0">
        <nav className="navbar navbar-expand-lg bg-white navbar-light py-3 px-lg-5">
          ...
          <div className="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
            <div className="navbar-nav mx-auto py-0">
              ...
              <Link to="/assignments" className="nav-item nav-link">Assignments</Link>
