...
function Signup() {    
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://studentkonnekt-backend-api.onrender.com/users/register", { first_name: firstName, last_name: lastName, email, password, role }) // Making a POST request to the register endpoint
            .then(result => {
